...
import { GetPrCategoryOfstore } from '../../../../../../Services/ProductService';
import { GetCategoryByID } from '../../../../../../Services/CategoryServices';
import { Badge } from 'react-bootstrap';
import ModalDeleteAll from '../../ModalDeleteAll';
import { AppContext } from '../../../../../../context/AppContext';
function Product_of_category_StoreU() {
    ...
    const {isCartChange,setIsCartChange}= useContext(AppContext);
    ...
    const getProducts = async () => {
        try {
            let res = await GetPrCategoryOfstore(getIduser, getIdProductofCategory);
            if (res && res.data) {
...
export default Product_of_category_StoreU;

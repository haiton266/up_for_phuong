    ...
    <>
      <Modal show={show} onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title>Confirm deletion of all products?11</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <div className="modal-content">
            <h2 className="text-danger">
              You already have products from another store in your cart. If you
              want to purchase this product, you need to remove all items from
              your cart.
            </h2>
          </div>
        </Modal.Body>
